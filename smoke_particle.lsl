...
// Particle paramaters
float age = 5.5;                  // Life of each particle
float maxSpeed = 0.06;            // Max speed each particle is spit out at
...
vector startColor = <0.75,0.75,0.75>;    // Start color of particles <R,G,B>
vector endColor = <0.65,0.65,0.65>;      // End color of particles <R,G,B> (if interpColor == TRUE)
vector startSize = <0.07,0.07,0.0>;     // Start size of particles 
vector endSize = <0.15,0.15,0.0>;       // End size of particles (if interpSize == TRUE)
